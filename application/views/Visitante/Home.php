<?= validation_errors(); //var_dump($acessorios);                    ?>
        <div class="container">
            <?php
            if (count($veiculos) > 0) {
                foreach ($veiculos as $v) {
                    ...
                    echo $opcionais . '.';
                    echo '<p><a href="#" class="text-info">Continue Lendo...</a></p>';
                    echo '</div>';
                    echo '<div class="col-md-5 order-md-1">';
                    echo '<img class="col-md-12" width="500" height="300" src="' . base_url('Incluir/teste2.jpg') . '">';
                    echo '</div>';
                    echo '</div>';
                }
            } else {
